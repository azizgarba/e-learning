                ...
                <div class="dash__content" style="position: relative;bottom: 100px;">
                    ...
                    <div class="dash__instructor-my-courses">
                      ...
                      <input type="text" name="search"  class="add_quiz_line_button_input" placeholder="Search..." >
                             ...
                             <div>
                           <input type="submit" name="submit" value="Chercher"  class="add_quiz_button">
                             </div>
...
$con = new PDO("mysql:host=localhost;dbname=e-learning_project-main",'root','');

if (isset($_POST["submit"])) {
	$str = $_POST["search"];
	$sth = $con->prepare("SELECT * FROM `questions` WHERE question_content like '$str%'");               
