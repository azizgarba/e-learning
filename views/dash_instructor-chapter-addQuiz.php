    ...
    <div class="dash">
        <div class="dash__side-bar">
            ...
            <div class="dash__side-bar__list">
                ...
                <a href="#" class="dash__side-bar__item">
                    <div class="dash__side-bar__item__icon">
                        <svg class="dash__side-bar__item__icon-svg" id="profile-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35.092 42.062">
                            <g id="user-icon">
                                <path id="Path_1029" data-name="Path 1029" d="M97.163,20.261a9.8,9.8,0,0,0,7.163-2.968,9.8,9.8,0,0,0,2.968-7.163,9.8,9.8,0,0,0-2.968-7.163A10.128,10.128,0,0,0,90,2.968a9.8,9.8,0,0,0-2.968,7.163A9.8,9.8,0,0,0,90,17.294,9.8,9.8,0,0,0,97.163,20.261Zm0,0" transform="translate(-79.882 0)" fill="currentColor" />
                                <path id="Path_1030" data-name="Path 1030" d="M35.007,259.342a25.018,25.018,0,0,0-.341-2.658,20.937,20.937,0,0,0-.654-2.672,13.2,13.2,0,0,0-1.1-2.492,9.4,9.4,0,0,0-1.657-2.159,7.3,7.3,0,0,0-2.379-1.5,8.224,8.224,0,0,0-3.038-.55,3.083,3.083,0,0,0-1.647.7c-.494.322-1.071.694-1.715,1.106a9.829,9.829,0,0,1-2.219.978,8.618,8.618,0,0,1-5.429,0,9.806,9.806,0,0,1-2.218-.977c-.638-.408-1.216-.78-1.717-1.106a3.079,3.079,0,0,0-1.646-.7,8.213,8.213,0,0,0-3.037.55,7.3,7.3,0,0,0-2.38,1.5,9.406,9.406,0,0,0-1.656,2.158,13.225,13.225,0,0,0-1.1,2.492,20.989,20.989,0,0,0-.653,2.672,24.933,24.933,0,0,0-.341,2.659c-.056.8-.084,1.64-.084,2.484a6.984,6.984,0,0,0,2.074,5.284,7.467,7.467,0,0,0,5.345,1.95H27.672a7.466,7.466,0,0,0,5.345-1.95,6.981,6.981,0,0,0,2.075-5.284c0-.848-.029-1.683-.085-2.484Zm0,0" transform="translate(0 -226.999)" fill="currentColor" />
                            </g>
                        </svg>
                    </div>
                        ...
                        <div class="course__add" style="padding: 0rem 0rem;">
                            ...
                            ?>
                                ...
                                <div style="padding: 1rem 0rem;">
                                    <div class="chapter">
                                        <h4><span style="">Chaptre <?php echo $i; ?>: &nbsp</span><?php echo $chapter['chapter_title']; ?></h4>
                                    ...
                                    <!--lesson line-->
                                    <?php include("formation_code/dashboard_instructor_lesson_line.php"); ?>
                                    <!--lesson line-->

                                    <!--show add new lesson-->
                                    <?php include("formation_code/dashboard_instructor_add_new_lesson.php"); ?>
                                    <!--show add new lesson-->
                                ...
                                <!--show update chapter-->
                                <?php include("formation_code/dashboard_instructor_show_update_chapter.php") ?>
                                <!--show update chapter-->
                    ...
                    <div class="public_information">
                        ...
                        <div class="course__add">
                            ...
                            <div class="course__add-v1" style="padding:0rem">
                                <a id="create_chapter" href="#" style="margin-top: 1rem; margin-left: 1.7rem;margin-bottom: 1rem; max-width: 23.4rem; ;" class="img_secondary-btn img_secondary-btn-topbar">
                                    <div>
                            ...
                            <div id="show_create_chapter" hidden>
                                ...
                                <div class="show_create_chapter">
                                    ...
                                    <form method="POST" id="add_chapter_id" action="formation_code/add_chapter.php?id=<?php echo $_GET['id']; ?>">


                                        <div class="form__input__group">
                                            <label for="chapter_title" class="form__input__label">Chapter title<span>*</span></label>
                                            <input id="chapter_title" name="chapter_title" type="text" class="form__input" style="padding-left:1.5rem" placeholder="Chapter title">
                                        </div>

                                        <div class="form__input__group">
                                            <label for="chapter_description" class="form__input__label">Chapter description<span>*</span></label>
                                            <textarea id="chapter_description" name="chapter_description" class="form__input" style="padding-left:1.5rem;resize: none;height: 11rem;" placeholder="Chapter description"></textarea>
                                        </div>

                                        <input class="primary-btn primary-btn-form" type="submit" value="Add New Chapter" style="width:100%">
                ...
                <div class="dash__content" style="position: relative;bottom: 100px;">
                    ...
                    <div class="dash__instructor-my-courses">
                        ...
                        <div   class="add_question_line_button">  
                                   ...
                                   <div>                   
                                    <input type="text" name="search"  class="add_quiz_line_button_input"placeholder="Search..." >
                                   </div>
                                   <div>
                                     <input type="submit" name="submit" value="Chercher"  class="add_question_button">
                                      </div>
                            ...
                            <div class="add_quiz_container">
                                <div class="add_quiz_content">
                                    <div class="add_quiz_content_l1">
                                        ...
                                        ?>
                                            <a type="button" href="./dash_instructor-chapter-add.php? edit=1 ; id=<?php echo $question['question_id']; ?>">  <i class="fas fa-pencil-alt" style="color:#000"></i></i> </a>
                                            <?php
                                             } else { 
                                                 if(isset($_POST['submitModification'])){
                                                     if(!empty($_POST['questionM']) && !empty($_POST['id'])){
                                                         $content = htmlspecialchars($_POST['questionM']);
                                                         $editId = htmlspecialchars($_POST['id']);
                                                         $bdd = new PDO('mysql:host=localhost;dbname=e-learning_project-main','root','');
                                                         $modifier = $bdd->prepare("UPDATE questions SET question_content = ? WHERE question_id = ?");
                                                         $modifier->execute(array($content,$editId));
                                                         echo "<script>location.href='dash_instructor-chapter-add.php';</script>";
                                                     }
                                                 }
                                                 
                                                 ?>
                                                <form method="post">
                                                 <input type="text" name="id" id="id" value="<?php echo $question['question_id'];?>" hidden />
                                                    <input type="text" name="questionM" id="questionM" value="<?php echo $question['question_content'];?>" />
                                                    <button type="submit" name="submitModification"> valider </button>
                                                </form>
                                            <?php }
                                            ?>
                                    ...
                                    ?>
                                        ...
                                        <div class="add_quiz_content_l2">
                                            ...
                                            echo $reponse['reponse_content'];?>
                                            
                                            <?php
                                             } else { 
                                                 if(isset($_POST['submitModification'])){
                                                     if(!empty($_POST['questionM']) && !empty($_POST['reponse_id'])){
                                                         $content = htmlspecialchars($_POST['questionM']);
                                                         $editId = htmlspecialchars($_POST['reponse_id']);
                                                         $bdd = new PDO('mysql:host=localhost;dbname=e-learning_project-main','root','');
                                                         $modifier = $bdd->prepare("UPDATE reponses SET reponse_content = ? WHERE reponse_id = ?");
                                                         $modifier->execute(array($content,$editId));
                                                         echo "<script>location.href='dash_instructor-chapter-add.php';</script>";
                                                     }
                                                 }
                                                 ...
                                                 ?>
                                                <form method="post">
                                                    <input type="text" name="reponse_id" id="reponse_id" value="<?php echo $reponse['reponse_id'];?>" hidden />
                                                    <input type="text" name="questionM" id="questionM" value="<?php echo $reponse['reponse_content'];?>" />
                                                    <button type="submit" name="submitModification"> valider </button>
                                                </form>
                                            <?php }
                                            ?>
