...
<head>
    ...
    <link rel="stylesheet" href="contents/css/style3.css" />
        ...
        <div class="dash__container">
            ...
            <div class="dash__content">
                <div class="dash__instructor-my-courses">
                    <h1 class="dash__instructor-my-courses__title" class="dashh">Quiz Result</h1> 
                    <hr>
                </div>

                <div class="dash__instructor-my-coursess">
                <table>
                    <tr>
                ...
                <a href="quizz1.php">
                <button class="next">  Try again </button> </a>
                <button class="preview"> Go home  </button>
